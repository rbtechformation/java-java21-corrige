...
public class Stream_03_Test {
	...
	public void test_max() throws Exception {
		...
		// Comment créer un comparator : Comparator<Order> comparator = Comparator.comparing(Order::getPrice);
	...
	public void test_flatMap() throws Exception {
		...
		// flatMap ne met à plat que des collections de Stream et non pas des collections de List ou des listes de List.
